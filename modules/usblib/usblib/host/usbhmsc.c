...
USBHMSCOpen(tUSBHostDevice *pDevice)
{
    ...
    {
        g_USBHMSCDevice.pfnCallback((unsigned int)&g_USBHMSCDevice,
                                    MSC_EVENT_OPEN, 0);
    }
...
//*****************************************************************************
static void
USBHMSCGetMaxLUN(unsigned int ulAddress, unsigned int ulInterface,
...
//*****************************************************************************
unsigned int
USBHMSCDriveOpen(unsigned int ulDrive, tUSBHMSCCallback pfnCallback)
{
    //
    ...
    //
    return((unsigned int)&g_USBHMSCDevice);
}
