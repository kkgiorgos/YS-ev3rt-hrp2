...
static STK_T _kernel_sstack_USB_CDC_TSK[COUNT_STK_T(STACK_SIZE)] __attribute__((section(".prsv_kernel"),nocommon));
static STK_T _kernel_sstack_USB_MSC_TSK[COUNT_STK_T(STACK_SIZE)] __attribute__((section(".prsv_kernel"),nocommon));
...
const TINIB _kernel_tinib_table[TNUM_STSKID] = {
	...
	{ &_kernel_dominib_kernel, (TA_NULL), (intptr_t)(0), ((TASK)(usb_cdc_task)), INT_PRIORITY(TPRI_USBMSC), ROUND_STK_T(STACK_SIZE), _kernel_sstack_USB_CDC_TSK, 0, NULL, (TA_NULL), (NULL), { TACP_KERNEL, TACP_KERNEL, TACP_KERNEL, TACP_KERNEL }},
	{ &_kernel_dominib_kernel, (TA_NULL), (intptr_t)(0), ((TASK)(usb_msc_task)), INT_PRIORITY(TPRI_USBMSC), ROUND_STK_T(STACK_SIZE), _kernel_sstack_USB_MSC_TSK, 0, NULL, (TA_NULL), (NULL), { TACP_KERNEL, TACP_KERNEL, TACP_KERNEL, TACP_KERNEL }},
...
const ID _kernel_torder_table[TNUM_STSKID] = {
	LOGTASK, BRICK_BTN_TSK, LCD_REFRESH_TSK, CONSOLE_BTN_TSK, BT_TSK, BT_QOS_TSK, USB_CDC_TSK, USB_MSC_TSK, EV3_INIT_TASK, PLATFORM_BUSY_TASK, EV3RT_LOGTASK, APP_TERM_TASK, ZMODEM_RECV_TASK
};
...
const CYCINIB _kernel_cycinib_table[TNUM_SCYCID] = {
	...
	{ (TA_STA), (intptr_t)(NULL), (cdc_sio_cyc), (5), (1), { TACP_KERNEL, TACP_KERNEL, TACP_KERNEL, TACP_KERNEL }},
